<template>
    <form-wrapper :action="type == 'create' ? '/api/client/store' : '/api/client/' + client.id + '/update'">
        <template slot-scope="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group" :class="{'has-error': form.errors.active }">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="active" value="1" v-model="client.active"> Aktiv
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="active" value="0" v-model="client.active"> Inaktiv
                            </label>
            ...
            <submit-button class="pull-right btn-sm btn-success" :text="type == 'create' ? 'Anlegen' : 'Speichern'" :loading="form.loading"></submit-button>
        </template>
    </form-wrapper>
</template>
