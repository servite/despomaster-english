                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group" :class="{'has-error': form.errors.married }">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="married" value="1" v-model="employee.married"> Verheiratet
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="married" value="0" v-model="employee.married"> Ledig
                            </label>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group" :class="{'has-error': form.errors.active }">
                            ...
                            <br>
                            <label class="radio-inline">
                                <input type="radio" name="active" value="1" v-model="employee.active"> Aktiv
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="active" value="0" v-model="employee.active"> Inaktiv
                            </label>
                        ...
                        <div class="col-md-4 form-group" :class="{'has-error': form.errors.applicant }">
                            <label>Bewerberstatus</label>
                            <div class="checkbox margin-t-0">
                                <input type="hidden" name="applicant" value="0">
                                <label>
                                    <input type="checkbox" name="applicant" value="1" v-model="employee.applicant"> Bewerber
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group" :class="{'has-error': form.errors.contractual_working_hours }">
                            <label>Vertragliche Arbeitszeit</label>
