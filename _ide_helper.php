 ...
 * Generated for Laravel 5.4.33 on 2017-09-07.
 *
...
namespace App\Services\Date\Facades { 
    ...
    class Date {
         ...
         * @static 
         */ 
        public static function format($date, $alias = 'date')
        {
            return \App\Services\Date\DateService::format($date, $alias);
        }
        ...
        {
            return \App\Services\Date\DateService::weekday($date);
        }
        ...
        {
            return \App\Services\Date\DateService::between($start, $end);
        }
        ...
        {
            return \App\Services\Date\DateService::monthName($int);
        }
         ...
         * @static 
         */ 
        public static function germanToSql($date)
        {
            return \App\Services\Date\DateService::germanToSql($date);
        }
         ...
         * @static 
         */ 
        public static function sqlToGerman($date)
        {
            return \App\Services\Date\DateService::sqlToGerman($date);
        }
...
namespace App\Services\Time\Facades { 
    ...
    class Time {
         ...
         * @static 
         */ 
        public static function calculateDiffInMin($start, $end, $break = 0)
        {
            return \App\Services\Time\TimeService::calculateDiffInMin($start, $end, $break);
        }
         ...
         * @static 
         */ 
        public static function output($total_min, $full = true)
        {
            return \App\Services\Time\TimeService::output($total_min, $full);
        }
         ...
         * @static 
         */ 
        public static function sanitze($value)
        {
            return \App\Services\Time\TimeService::sanitze($value);
        }
        ...
        {
            return \App\Services\Time\TimeService::format($value);
        }
...
namespace App\Services\Notify\Facades { 
    ...
    class Notify {
        ...
        /**
         * Helper method for flashing a success message.
         *
         * @param string $message
         * @param array $options
         * @return void 
        ...
        {
            \App\Services\Notify\Notify::success($message, $options);
        }
        
        /**
         * Helper method for flashing an error message.
         *
         * @param string $message
         * @param array $options
         * @return void 
        ...
        {
            \App\Services\Notify\Notify::error($message, $options);
        }
         ...
         * @static 
         */ 
        public static function flash($message, $type = null, $options = array())
        {
            return \App\Services\Notify\Notify::flash($message, $type, $options);
        }
        ...
        {
            return \App\Services\Notify\Notify::get($array);
        }
        ...
        {
            return \App\Services\Notify\Notify::ready();
        }
        ...
        {
            return \App\Services\Notify\Notify::message();
        }
        ...
        {
            return \App\Services\Notify\Notify::type();
        }
         ...
         * @static 
         */ 
        public static function options($array = false)
        {
            return \App\Services\Notify\Notify::options($array);
        }
        ...
        {
            return \App\Services\Notify\Notify::option($key, $default);
        }
...
namespace  { 
    ...
    class Date extends \App\Services\Date\Facades\Date {}

    class Time extends \App\Services\Time\Facades\Time {}

    class Notify extends \App\Services\Notify\Facades\Notify {}
